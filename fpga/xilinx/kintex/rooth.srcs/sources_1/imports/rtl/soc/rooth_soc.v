...
clk_pll clk_pll_inst(
    ...
    .clk_out2           ( clk_double            ),     // output clk_out2
    .locked             ( locked_sig            ),     // output locked
    .clk_in1            ( refer_clk             )
);
...
inst_mem inst_mem_0 (
  ...
  .ena                      ( s0_we_o                   ),      // input wire ena
  .wea                      ( s0_we_o                   ),      // input wire [0 : 0] wea
  .addra                    ( {2'b0,s0_addr_o[`CPU_WIDTH-1:2]}),  // input wire [11 : 0] addra
  .dina                     ( s0_data_o                 ),    // input wire [31 : 0] dina
  .douta                    ( s0_data_i                 )  // output wire [31 : 0] douta
);

data_mem data_mem_0 (
  .clka                     ( clk_double                ),    // input wire clka
  .ena                      ( s1_we_o                   ),      // input wire ena
  .wea                      ( s1_we_o                   ),      // input wire [0 : 0] wea
  .addra                    ( {2'b0,s1_addr_o[`CPU_WIDTH-1:2]}),  // input wire [11 : 0] addra
  .dina                     ( s1_data_o                 ),    // input wire [31 : 0] dina
  .douta                    ( s1_data_i                 )  // output wire [31 : 0] douta
);
