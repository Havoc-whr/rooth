...
HD_PWD='D:/Vivado_prj/flash_rooth/flash_rooth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_rooth_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flash_rooth_wrapper.tcl -notrace
