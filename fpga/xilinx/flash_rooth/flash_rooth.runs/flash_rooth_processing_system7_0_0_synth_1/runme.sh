...
HD_PWD='D:/Vivado_prj/flash_rooth/flash_rooth.runs/flash_rooth_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_rooth_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flash_rooth_processing_system7_0_0.tcl
