...
HD_PWD='D:/Vivado_prj/flash_rooth/flash_rooth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_rooth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flash_rooth_wrapper.tcl
