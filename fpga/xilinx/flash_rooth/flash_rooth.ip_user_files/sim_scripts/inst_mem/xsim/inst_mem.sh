...
#
# Generated by Vivado on Sun Mar 05 22:26:05 +0800 2023
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_mem xil_defaultlib.inst_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim inst_mem -key {Behavioral:sim_1:Functional:inst_mem} -tclbatch cmd.tcl -protoinst "protoinst_files/flash_rooth.protoinst" -log simulate.log
}
