...
#
# Generated by Vivado on Sat Mar 04 20:53:39 +0800 2023
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_pll xil_defaultlib.clk_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_pll -key {Behavioral:sim_1:Functional:clk_pll} -tclbatch cmd.tcl -protoinst "protoinst_files/flash_rooth.protoinst" -log simulate.log
}
