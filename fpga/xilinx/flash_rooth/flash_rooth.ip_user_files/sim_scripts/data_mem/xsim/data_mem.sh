...
#
# Generated by Vivado on Sat Mar 04 20:54:44 +0800 2023
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_mem xil_defaultlib.data_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim data_mem -key {Behavioral:sim_1:Functional:data_mem} -tclbatch cmd.tcl -protoinst "protoinst_files/flash_rooth.protoinst" -log simulate.log
}
