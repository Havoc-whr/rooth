...
HD_PWD='D:/rooth/rooth-fpga/xilinx/ZYNQXC7Z020/ZYNQXC7Z020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rooth_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rooth_soc.tcl -notrace
